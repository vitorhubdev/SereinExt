...
!if /FileExists "packaging\windows\Nivra.ico"
  !define MUI_ICON "packaging\windows\Nivra.ico"
  !define MUI_UNICON "packaging\windows\Nivra.ico"
!else if /FileExists "${__FILEDIR__}\Nivra.ico"
  !define MUI_ICON "${__FILEDIR__}\Nivra.ico"
  !define MUI_UNICON "${__FILEDIR__}\Nivra.ico"
!else if /FileExists "Nivra.ico"
  !define MUI_ICON "Nivra.ico"
  !define MUI_UNICON "Nivra.ico"
!else
  !define MUI_ICON "${__FILEDIR__}\Nivra.ico"
  !define MUI_UNICON "${__FILEDIR__}\Nivra.ico"
!endif
